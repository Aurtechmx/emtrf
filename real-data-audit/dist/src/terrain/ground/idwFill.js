 ...
 */
function idwFill(z, hadData, cols, rows, params = {}) {
    const n = cols * rows;
    ...
    for (let row = 0; row < rows; row++) {
        for (let col = 0; col < cols; col++) {
            ...
            while (radius <= maxRadius) {
                ...
                if (found >= kNearest && lastFoundRadius < 0)
                ...
                if (lastFoundRadius >= 0 && radius >= lastFoundRadius + 1)
                    break;
                radius++;
            }
