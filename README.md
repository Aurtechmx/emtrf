...
Archived on Zenodo under concept DOI [10.5281/zenodo.21992294](https://doi.org/10.5281/zenodo.21992294), which resolves to the latest version. Each tagged release has its own version DOI; see the repository Releases and `CITATION.cff`.
