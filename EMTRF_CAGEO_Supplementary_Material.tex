...
\usepackage{url}
\usepackage{seqsplit}
\newcommand{\hexid}[1]{\allowbreak\seqsplit{#1}}
...
\begin{table}[h]
\centering
\caption*{\textbf{Table S2.} Site-specific four-pipeline ablation and performance diagnostics at one source-cell tolerance (the per-site detail behind the main-text P0--P3 ablation summary table). ``EP promote'' is the endpoint-only rate shared by P0/P1; ``Grade loss'' is the rate shared by P0/P2; ``Typed-EP loss'' is P1. The P3 column reports support-promotion/provenance-loss counts. The EC-DP overhead per kilometre is a secondary microtiming diagnostic; the paired 5,305-vertex benchmark in the main text is the primary runtime estimate. Counts are the strict reconstruction, which retains every eligible span. The 2026 archived record contains 184 Marsh Island spans and 87.5\% reduction, where the strict reconstruction yields 186; the two additional eligible records are one-edge feature runs. Because the original eligibility rule was not preserved, the strict reconstruction is reported here and the archived result is retained in the repository as a historical cross-check.}
\vspace{2mm}
\small
...
Marsh Island & 186 & 87.4\% & 4.3\% & 98.4\% & 0.0\% & 0/0 & 2.78 \\
\bottomrule
\end{tabular}
\end{table}
...
\hexid{4fb00a784d860a2e24cc1834d6c1230dac550355} (version {DOI} 10.5281/zenodo.21933671, source-archive SHA-256
\hexid{fdb510e3416fb0cb02c71031bb7f653b8e0dde83ae9916c85d1c44e844b122fa}). The identical mapping also appears
unchanged in earlier v0.6.4 development snapshots (2026-08-09, SHA-256
\hexid{71507a5115de8c8ad9125215e30222d87ca1cd400308fd464cebaac269373aaf} and
\hexid{1dfe94ef79838772730a04df66037b973a7be6b42abeecbf6f6ad7d6fd6c145f}), confirming the counterexample is a
...
Third-party contour geometry & GDAL \code{gdal\_contour} attribute schema; endpoint-only vs.\ complete-arc promotion on GDAL geometry & Independent EC-DP reimplementation; population prevalence across GIS tools \\
